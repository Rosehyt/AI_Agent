...
def run_evaluation():
    ...
    from config import ACTIVE_EMBEDDING, LOCAL_EMBEDDING_MODEL
    print(f"🤖 Agent Mode: {TEST_MODE}")
    print(f"🧠 Embedding Model: [{ACTIVE_EMBEDDING.upper()}] {LOCAL_EMBEDDING_MODEL}")
    print(f"==================================================\n")
    ...
    for test in TEST_CASES:
        ...
        print("-" * 50)
        print(colored("⏳ Waiting 10 seconds to avoid Gemini API Rate Limit...", "yellow"))
        time.sleep(10)
